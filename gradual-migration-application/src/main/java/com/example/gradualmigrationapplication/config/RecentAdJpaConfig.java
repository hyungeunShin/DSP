package com.example.gradualmigrationapplication.config;
...
@EnableJpaRepositories(
        basePackages = "com.example.gradualmigrationapplication.domain.recent",
...
public class RecentAdJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean recentAdEntityManagerFactory(
        ...
        LocalContainerEntityManagerFactoryBean factoryBean = builder.dataSource(dataSource)
                                                                    .packages("com.example.gradualmigrationapplication.domain.recent")
                                                                    .build();
